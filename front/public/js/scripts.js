...
---------------------------------------------------*/	
	...
	function FitThumbScreen() {
		...
		$('.item .grid__item-img').on('click', function() {
			...
			gsap.to('#ball', {duration: 0.6, borderWidth: '4px', scale:0.5, borderColor:'#999999', backgroundColor:'transparent'});
			gsap.to('#ball-loader', {duration: 0.6, borderWidth: '4px', top: 0, left: 0});
			$("#ball").removeClass("with-icon");
			$('#ball p').remove();
			$('#ball i').remove();
		...
		$('#itemsWrapperLinks .trigger-slide-link').on('click', function() {
			...
			$("body").addClass("load-project-thumb").addClass("show-loader");
			gsap.to($("#showcase-slider .swiper-slide .inner"), {duration: 0.5, force3D:true, delay:0, opacity:0, ease:Power3.easeInOut  });
			gsap.to($("#showcase-slider .swiper-slide.above").prevAll(), {duration: 0.9, force3D:true, x:-300, scale:1.1, delay:0, opacity:0, ease:Power3.easeInOut  });
			gsap.to($("#showcase-slider .swiper-slide.above").nextAll(), {duration: 0.9, force3D:true, x:300, scale:1.1, delay:0, opacity:0, ease:Power3.easeInOut  });
